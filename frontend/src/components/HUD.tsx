...
import { Satellite, Trash2, Rocket, AlertTriangle } from 'lucide-react'
...
export function HUD() {
  ...
  const categories = [
    { key: 'active_satellite', label: 'Satellites', icon: Satellite, color: 'text-satellite', bg: 'bg-satellite/10', border: 'border-satellite/30' },
    { key: 'debris', label: 'Debris', icon: Trash2, color: 'text-debris', bg: 'bg-debris/10', border: 'border-debris/40' },
    { key: 'rocket_body', label: 'Rocket bodies', icon: Rocket, color: 'text-rocket', bg: 'bg-rocket/10', border: 'border-rocket/40' },
  ]
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10">
      ...
      <div className="absolute top-0 left-0 right-0 p-5 grid grid-cols-[1fr_auto_1fr] items-start">
        ...
        <div className="pointer-events-auto rounded border border-white/10 bg-panel/90 px-5 py-2 text-center min-w-40">
